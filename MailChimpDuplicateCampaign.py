...
selectFile = fd.askopenfilename(title="Select File to Duplicate MailChimp Campaign", initialdir=os.path.expanduser('~')+'\\Desktop\\', filetypes=[("Excel", ".xlsx .xls"),("CSV", ".csv")])
...
for x in range(len(df)):
	...
	if df.iloc[x]['ScheduleCampaign'].upper() == 'Y':
		...
		logger.info("Campaign is not scheduled.")
